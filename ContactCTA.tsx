        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-orange-600 to-orange-700 rounded-[3.5rem] p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl shadow-orange-900/40">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              <a href="https://calendly.com/jcad-creatives/discovery-call" target="_blank" rel="noopener noreferrer" className="px-12 py-6 bg-white text-orange-600 rounded-full font-black text-xl hover:scale-105 transition-all shadow-2xl shadow-black/20 group inline-block">
