            ...
            {samples.map((sample, index) => {
              ...
              return (
                <div 
                  key={sample.id} 
                  style={style} 
                  className="absolute inset-0 bg-neutral-900 rounded-[3rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border border-white/10 group pointer-events-none"
                >
                  <img src={sample.imageUrl} alt={sample.brand} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[2s]" />
